(function (window, undefined) {
    ...
    var self = this;
    var selectColumns = 'Name, Facilitytype, Ward, coordinates ';
      ...
      for (var row in data) {
        template = "\
          <div class='row-fluid item-list'>\
            <div class='span12'>\
              <strong><a id='map_canvas' href='google.navigation:q="+ data[row][3] + ","+ data[row][3] + "(Label,"+ data[row][0] + ")'>" + data[row][0] + "</a></strong>\
              <br />\
              " + data[row][1] + "\
              <br />\
              " + data[row][2] + "\
